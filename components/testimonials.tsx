...
export default function Testimonials() {
  ...
  const testimonialsPerPage = 1 // 1 en móvil, 3 en desktop
    ...
    <section className="py-20 bg-[#f8fdf8]">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            onClick={prevPage}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50"
          >
                ...
                {testimonials.map((testimonial, index) => (
                  <div 
                    ...
                    className={`bg-white p-6 rounded-lg shadow-md ${
                      // En móvil, mostrar solo el testimonio actual
                      // En desktop, mostrar los 3 testimonios
                      index === currentPage ? 'block md:block' : 'hidden md:block'
                    }`}
                  >
          ...
          <button
            onClick={nextPage}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50"
          >
